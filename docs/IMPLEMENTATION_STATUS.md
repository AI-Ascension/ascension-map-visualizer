...
The dense harness fixture at `3c4470f0940e3668519194e13b59f234e75821a7` contains 76 nodes and 182 edges. Clean source commit `0fb467055ae907e1bbb2cae1f12b6210656c1deb` was built and packaged natively on Linux and Windows. Both archives were extracted, checksum-verified, and used to run `doctor`, reproduce the offline demo, and validate it. All ten generated files were byte-identical across platforms, including PNG, SVG, and browser assets; see [native comparison](evidence/native-demo-comparison.json) and [packaging evidence](evidence/native-packaging.json).

The updated source passed all 31 Linux and 29 Windows Rust tests, formatting, and Clippy. Unix-only path/symlink tests explain the platform count difference. Dependency advisories/licenses/sources passed after the keyed telemetry repair. Browser commit `04d6d00` passed all 18 desktop/mobile tests with fresh actual-CLI bundles; missing generated inputs fail CI. Hosted CI passed all five jobs at `088ef00`, including native packaging and the generated-bundle browser gate. The later telemetry/notices update at `0fb4670` is separately awaiting hosted CI. Product PR [#2](https://github.com/AI-Ascension/ascension-map-visualizer/pull/2) remains a draft.
