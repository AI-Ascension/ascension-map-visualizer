...
All fixture JSON is copied from the harness owner at the exact per-artifact source commit and file hashes in `contract-artifacts/harness/provenance.json`, under MIT. No game assets, native process data, model transcript, or credentials are included.
