...
// Viewer entrypoint: layout, rendering, interaction, replay/live loading and boot wiring.
// viewer-core.js and viewer-validation.js must load first (see index.html).
(function () {
  "use strict";

  var core = window.__ASCENSION_MAP_MODULES__.core;
  var validation = window.__ASCENSION_MAP_MODULES__.validation;
  var VIEWBOX = core.VIEWBOX, COMPACT_VIEWBOX_WIDTH = core.COMPACT_VIEWBOX_WIDTH;
  var POLL_MS = core.POLL_MS, ZOOM_MIN = core.ZOOM_MIN, ZOOM_MAX = core.ZOOM_MAX;
  var refs = core.refs, state = core.state;
  var byId = core.byId, make = core.make, makeSvg = core.makeSvg, removeChildren = core.removeChildren;
  var validatePayload = validation.validatePayload, parseJsonBuffer = validation.parseJsonBuffer;
  var validateReplay = validation.validateReplay, validateAndFreezePayload = validation.validateAndFreezePayload;
